...
window.PORTFOLIO = {
  ...
  cases: [
    ...
    { id:'zalopay', href:'zalopay.html', badge:'Independent analysis',
      title:"ZaloPay: Launched first, deleted after one trip",
      thumb:'<div class="wthumb zpviz"><span class="wtag"><i style="--c:#01CF6A"></i>Independent Research · Fintech</span><span class="logochip"><img src="assets/zp-logo.svg" alt="ZaloPay logo"></span><svg viewBox="0 0 240 110" aria-hidden="true"><circle cx="30" cy="82" r="7" fill="#fff"/><path d="M30 82 C 80 82, 90 22, 140 22" fill="none" stroke="#01CF6A" stroke-width="3.5" stroke-linecap="round"/><path d="M140 22 C 175 22, 185 46, 212 46" fill="none" stroke="#6BE8A8" stroke-width="3" stroke-linecap="round" stroke-dasharray="5 6"/><circle cx="140" cy="22" r="6" fill="#01CF6A"/><circle cx="212" cy="46" r="6" fill="#6BE8A8"/><text x="30" y="104" text-anchor="middle" font-family="Manrope,sans-serif" font-size="10" font-weight="700" fill="rgba(255,255,255,.6)">VN</text><text x="140" y="12" text-anchor="middle" font-family="Manrope,sans-serif" font-size="10" font-weight="700" fill="rgba(255,255,255,.75)">abroad</text></svg><span class="zt">Cross-border · The Trip Wallet</span></div>',
      base:{ desc:"ZaloPay launched cross-border QR first. By April 2026 MoMo ran the same offer and Vietcombank sold it in 50+ countries. Three verified problems, then one shared trip wallet that answers what keeps the app after the flight home.",
        metrics:["Channel diagnosis","Break-even model","Product concept"] },
      growth:{ ctx:"First to cross-border QR, then matched by MoMo and out-covered by a bank — where is the defensible advantage?",
        myrole:"Channel-by-channel diagnosis on 2026 data — including the finding that Zalo's own group-split settles through banks, not ZaloPay — then a shared trip wallet, mocked up end to end.",
        metrics:["Channel diagnosis","Break-even model","Media & growth plan"] } },
    ...
    { id:'tgdd', href:'tgdd.html', badge:'Tomorrow Marketers',
      title:"Thế Giới Di Động: Độ phủ không còn là lợi thế",
      thumb:'<div class="wthumb tgviz"><span class="wtag"><i style="--c:#FFCD00"></i>Retail Branding · Tiếng Việt</span><span class="tgmark"><svg viewBox="0 0 30 30" aria-hidden="true"><circle cx="15" cy="15" r="15" fill="#111"/><g fill="#FFCD00"><rect x="7" y="17" width="4" height="4"/><rect x="11" y="13" width="4" height="4"/><rect x="15" y="9" width="4" height="4"/><rect x="19" y="13" width="4" height="4"/><rect x="11" y="21" width="4" height="4"/></g></svg><b>thegioididong</b></span><svg class="tgchart" viewBox="0 0 240 96" aria-hidden="true"><line x1="12" y1="70" x2="228" y2="70" stroke="rgba(255,255,255,.2)"/><rect x="26" y="30" width="26" height="40" rx="3" fill="#B7791F"/><rect x="66" y="20" width="26" height="50" rx="3" fill="#B7791F"/><rect x="106" y="36" width="26" height="34" rx="3" fill="#B7791F"/><rect x="186" y="56" width="26" height="14" rx="3" fill="#5B8DEF"/><text x="199" y="50" text-anchor="middle" font-family="Manrope,sans-serif" font-size="9.5" font-weight="700" fill="rgba(255,255,255,.75)">brand</text><text x="12" y="88" font-family="Manrope,sans-serif" font-size="9.5" font-weight="700" fill="rgba(255,255,255,.5)">P&amp;L fixed · brand not</text></svg><span class="tgt">Độ phủ &gt; Độ tin cậy</span></div>',
      base:{ desc:"Bản tiếng Việt, dạng slide ngang. Khi sản phẩm, giá và độ phủ đều hội tụ, mạng lưới lớn nhất thành chi phí lớn nhất — định vị lại, kiến trúc giá, vai trò portfolio và growth driver.",
        metrics:["Repositioning","Pricing architecture","Portfolio roles"] },
      brand:{ desc:"Case brand strategy bán lẻ (bản tiếng Việt, deck ngang): TGDĐ sửa được P&L bằng đóng cửa hàng nhưng chưa trả lời câu hỏi thương hiệu. Định vị lại quanh sự an tâm, có giá và đo được.",
